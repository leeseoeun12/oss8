...
- 1) 제품 설계  
   ...
   **c.도면 작성**
   ...
   - *개요* : 다양한 용도로 여러 도면 템플릿을 작성, 각 템플릿에서 제목 블록 및 시트 크기와 같은 표준 도면 피쳐를 사용자화하는 방법을 설명함.
   - *도면 템플릿 정보* : 각각의 새 도면은 템플릿에서 작성됨, 기본 템플릿은 응용 프로그램 옵션에 설정된 기본 제도 표준에 따라 지정됨. 공통 템플릿을 사용하면 반복적으로 수행되는 작업을 줄임.
   - *도면 뷰* : Inventor에서 사용 가능한 다양한 구성요소 및 조립품 뷰, 구성 방법, 뷰 간의 관계 이해함.
   - *도면 주석* : 도면의 치수, 중심선, 기호, 테이블, 부품 리스트 및 기타 주석을 작성하고 관리함.
   - *GOST 도면 정보* : ESKD 지원 애드인에는 도면에 GOST 주석을 삽입하는 도구가 포함됨.
- 2) 공동 작업(1)
